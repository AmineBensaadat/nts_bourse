...
class _SubscriptionState extends State<Subscription> {
  final _formKeySubscription = GlobalKey<FormState>();
  Color BorderTextFiledColor = Colors.grey;
  List<String> listTypeCours = ['RACHAT', 'SOUSCRIPTION'];
  String? sens = 'SOUSCRIPTION'; //no radio button will be selected
  String selectval = 'SOUSCRIPTION';
  bool montantReadOnly = false;
  bool nbrPartReadOnly = true;
